 ...
 */
  ...
  $bar->appendButton( 'Popup', 'print', $alt, 'index.php?option='.$option.'&task=report&id=rep001&pop=1&tmpl=component', 640, 480 );
...
<form action="index.php" method="post" name="adminForm" id="adminForm">
  ...
  <table width="98%" class="admintable">
       ...
       <?php
        ...
        &nbsp;
			...
			<td width="35%" align="right">
					<?php echo JText::_( 'COD_REP' ); ?> : <?php echo 'REP001'; ?>
			</td>		
		</tr>
		<tr>
		  <td colspan="3" style="text-align: center;"><h2><?php echo JText::_( 'REP_001' ); ?></h2></td>
		</tr>		
	</table>
  ...
  <tr>
    <th width="5">#</th>
		...
		<th width="5%"><?php echo JText::_( 'skebby_message_id' ); ?></th>
		<th width="15%"><?php echo JText::_( 'recipient' ); ?></th>
		<th width="5%"><?php echo JText::_( 'status' ); ?></th>
		<th width="5%"><?php echo JText::_( 'error_code' ); ?></th>
		<th width="35%"><?php echo JText::_( 'error_message' ); ?></th>
		<th width="5%"><?php echo JText::_( 'user_reference' ); ?></th>
		<th width="10%"><?php echo JText::_( 'skebby_date_time' ); ?></th>
		<th width="10%"><?php echo JText::_( 'operator_date_time' ); ?></th>
  ...
  ?>
    <tr class="row<?php echo $k; ?>">
        ...
        <td align="left"><?php echo $item->skebby_message_id; ?></td>
        <td align="left"><?php echo $item->recipient; ?></td>
        ...
        <td align="left"><?php if( $item->skebby_date_time!='0000-00-00 00:00:00' ){ echo date_format(date_create($item->skebby_date_time),"d/m/Y"); }else { echo '&nbsp'; } ?></td>
				<td align="left"><?php if( $item->skebby_date_time!='0000-00-00 00:00:00' ){ echo date_format(date_create($item->operator_date_time),"d/m/Y"); }else { echo '&nbsp'; } ?></td>
